...
def main():
    ...
    #cap = cv2.VideoCapture("http://192.168.9.9:5000/video_feed")
    ...
    while cap.isOpened():
        ...
        timeout_diff = timeout_end - timeout_start
        if timeout_diff > 3:
            print("Timeout, cant detect image within 3secs.")
            cap.release()
        ...
        timer_text = str(int(timeout_diff))
        cv2.putText(frame, timer_text,(600,30), cv2.FONT_HERSHEY_SIMPLEX, 1,(0,255,255),2)
